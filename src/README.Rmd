...
\ \ \ \ \ \ \ \ \ \ \ \ \ \ 
y<sub>*it*</sub> = &beta;X<sub>*it*</sub> + &alpha;<sub>*i*</sub> + &epsilon;<sub>*it*</sub> \ \ \ for *t* = 1...*T* and *i* = 1...*N*
\ \ \ \ \ \ \ \ \ \ \ \ \ \ (1)
...
\ \ \ \ \ \ \ \ \ \ \ \ \ \ 
*AUC*<sub>*event*</sub> = &sum;X<sub>&beta;</sub>&delta;<sub>*t*</sub>
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ (2)  
...
\ \ \ \ \ \ \ \ \ \ \ \ \ \ 
&sigma;<sub>*AUC*</sub> = &delta;<sub>*t*</sub>'**&Sigma;**<sub>*t*</sub>&delta;<sub>*t*</sub>
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \  \ \ \ \ \ (3)  
